...
model = MyModel()
model.double()
model.load_state_dict(torch.load('trained_model/2018_08_06/epoch_1360_model.ckpt'))

joint_t = np.load('data/train/joint/joint_00028.npy')
pose_t = np.load('data/train/pose/pose_00028.npy')
